    ...
    >
      <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center space-x-8">
          <a href="#" className="text-white hover:text-digital-purple transition-colors">Soluções</a>
          <a href="#" className="text-white hover:text-digital-purple transition-colors">Produtos</a>
          <a href="#" className="text-white hover:text-digital-purple transition-colors">Diferenciais</a>
          <a href="#" className="text-white hover:text-digital-purple transition-colors">Sobre nós</a>
          <a href="#" className="text-white hover:text-digital-purple transition-colors">Contato</a>
        </nav>
        
        <div className="hidden lg:block">
          <Button className="bg-digital-purple hover:bg-digital-purple/90 text-white px-6">
            Solicitar Solução
          </Button>
        </div>
      ...
      {isMenuOpen && (
        <div className="lg:hidden fixed inset-0 top-[65px] bg-digital-dark-purple/95 backdrop-blur-md flex flex-col z-40 animate-fade-in">
          <div className="container mx-auto px-4 pt-8 pb-16 flex flex-col gap-6">
            ...
            <Button className="bg-digital-purple hover:bg-digital-purple/90 text-white px-6 py-6 mt-4">
              Solicitar Solução
            </Button>
          </div>
        </div>
